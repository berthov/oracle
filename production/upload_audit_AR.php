...
if ($handle = opendir('uploads/ben/<?php echo $DO_NUM ?>/')) {
    while (false !== ($entry = readdir($handle))) {
        if ($entry != "." && $entry != "..") {
            echo "$entry\n";
            ?>
            <!-- <embed src="uploads/ben/7543/<?php echo $entry ?>" width="100%" height="750"> -->
              <iframe src="uploads/ben/<?php echo $DO_NUM ?>/<?php echo $entry ?>" style="width:100%; height:700px;" frameborder="0"></iframe>
              <br>
            <?php
        }
    }
                    ...
                    <div class="col-xs-6 col-md-6">
                      ...
                      <div class="form-group">
                        <form enctype="multipart/form-data" action="controller/upload_audit_P.php" method="post">
                          ...
                          <br>
                          <input type="hidden" name="DO_NUM" value="<?php echo $DO_NUM; ?>">
